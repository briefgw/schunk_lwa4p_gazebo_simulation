...
if("FALSE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-velocity-controllers-0.11.1)
  set(velocity_controllers_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-velocity-controllers-0.11.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()

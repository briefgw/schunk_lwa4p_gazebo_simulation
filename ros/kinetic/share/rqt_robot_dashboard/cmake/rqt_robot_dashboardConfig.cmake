...
if("FALSE" STREQUAL "TRUE")
  set(rqt_robot_dashboard_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rqt-robot-dashboard-0.5.3)
  set(rqt_robot_dashboard_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rqt-robot-dashboard-0.5.3/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_robot_dashboard_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_robot_dashboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
    endif()

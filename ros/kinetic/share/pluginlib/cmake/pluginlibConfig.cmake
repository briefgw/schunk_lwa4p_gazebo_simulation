...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-pluginlib-1.10.2)
  set(pluginlib_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-pluginlib-1.10.2/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()

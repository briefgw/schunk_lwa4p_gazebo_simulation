...
if("FALSE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-urdf-tutorial-0.2.4)
  set(urdf_tutorial_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-urdf-tutorial-0.2.4/obj-x86_64-linux-gnu/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()

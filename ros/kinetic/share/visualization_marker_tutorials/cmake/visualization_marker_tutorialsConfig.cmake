...
if("FALSE" STREQUAL "TRUE")
  set(visualization_marker_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-visualization-marker-tutorials-0.10.1)
  set(visualization_marker_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-visualization-marker-tutorials-0.10.1/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visualization_marker_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'William Woodall <william@osrfoundation.org>' to fix it.")
    endif()

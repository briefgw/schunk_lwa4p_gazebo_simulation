...
if("FALSE" STREQUAL "TRUE")
  set(turtle_actionlib_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-turtle-actionlib-0.1.8)
  set(turtle_actionlib_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-turtle-actionlib-0.1.8/obj-x86_64-linux-gnu/devel)
  ...
  set(turtle_actionlib_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtle_actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()

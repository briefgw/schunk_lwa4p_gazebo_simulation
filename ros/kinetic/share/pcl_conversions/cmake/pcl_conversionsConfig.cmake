...
if("FALSE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-pcl-conversions-0.2.1)
  set(pcl_conversions_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-pcl-conversions-0.2.1/obj-x86_64-linux-gnu/devel)
  ...
  set(pcl_conversions_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()

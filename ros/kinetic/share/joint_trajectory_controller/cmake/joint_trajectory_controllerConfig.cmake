...
if("FALSE" STREQUAL "TRUE")
  set(joint_trajectory_controller_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-joint-trajectory-controller-0.11.1)
  set(joint_trajectory_controller_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-joint-trajectory-controller-0.11.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(compressed_depth_image_transport_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-compressed-depth-image-transport-1.9.3)
  set(compressed_depth_image_transport_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-compressed-depth-image-transport-1.9.3/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.1.0-dev/opencv;/opt/ros/kinetic/include/opencv-3.1.0-dev " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'David Gossow <dgossow@willowgarage.com>' to fix it.")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-eigen-conversions-1.11.8)
  set(eigen_conversions_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-eigen-conversions-1.11.8/obj-x86_64-linux-gnu/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()

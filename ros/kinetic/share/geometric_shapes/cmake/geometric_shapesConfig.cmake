...
if("FALSE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-geometric-shapes-0.4.4)
  set(geometric_shapes_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-geometric-shapes-0.4.4/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-camera-calibration-parsers-1.11.10)
  set(camera_calibration_parsers_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-camera-calibration-parsers-1.11.10/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-ros-2.5.6)
  set(gazebo_ros_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-ros-2.5.6/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()

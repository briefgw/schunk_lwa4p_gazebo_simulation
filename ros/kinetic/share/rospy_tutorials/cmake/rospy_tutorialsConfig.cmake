...
if("FALSE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rospy-tutorials-0.7.0)
  set(rospy_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rospy-tutorials-0.7.0/obj-x86_64-linux-gnu/devel)
  ...
  set(rospy_tutorials_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()

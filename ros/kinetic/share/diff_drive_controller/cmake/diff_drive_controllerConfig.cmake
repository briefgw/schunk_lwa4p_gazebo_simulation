...
if("FALSE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-diff-drive-controller-0.11.1)
  set(diff_drive_controller_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-diff-drive-controller-0.11.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Bence Magyar <bence.magyar@pal-robotics.com>' to fix it.")
    endif()

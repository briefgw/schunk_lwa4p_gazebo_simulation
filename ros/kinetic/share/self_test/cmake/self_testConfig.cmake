...
if("FALSE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-self-test-1.8.9)
  set(self_test_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-self-test-1.8.9/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()

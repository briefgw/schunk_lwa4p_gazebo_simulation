...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosgraph-msgs-1.11.2)
  set(rosgraph_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosgraph-msgs-1.11.2/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()

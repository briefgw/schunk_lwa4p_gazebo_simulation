...
if("FALSE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosbash-1.13.1)
  set(rosbash_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosbash-1.13.1/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()

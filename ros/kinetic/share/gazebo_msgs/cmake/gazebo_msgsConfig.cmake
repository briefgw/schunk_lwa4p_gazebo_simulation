...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-msgs-2.5.6)
  set(gazebo_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-gazebo-msgs-2.5.6/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()

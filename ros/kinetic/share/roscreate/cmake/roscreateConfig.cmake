...
if("FALSE" STREQUAL "TRUE")
  set(roscreate_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-roscreate-1.13.1)
  set(roscreate_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-roscreate-1.13.1/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()

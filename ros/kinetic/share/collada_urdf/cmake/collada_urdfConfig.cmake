...
if("FALSE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-collada-urdf-1.12.2)
  set(collada_urdf_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-collada-urdf-1.12.2/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()

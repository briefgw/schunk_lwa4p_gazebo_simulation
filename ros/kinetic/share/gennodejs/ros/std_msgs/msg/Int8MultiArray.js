...
class Int8MultiArray {
  ...
  static serialize(obj, bufferInfo) {
    // Serializes a message object of type Int8MultiArray
  ...
  static deserialize(buffer) {
    //deserializes a message object of type Int8MultiArray
    let tmp;
    let len;
    let data = new Int8MultiArray();

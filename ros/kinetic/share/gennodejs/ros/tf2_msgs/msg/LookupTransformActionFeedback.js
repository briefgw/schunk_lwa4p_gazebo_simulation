...
class LookupTransformActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = LookupTransformFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new LookupTransformActionFeedback();
    ...
    tmp = LookupTransformFeedback.deserialize(buffer);

...
class FollowJointTrajectoryActionGoal {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = FollowJointTrajectoryGoal.serialize(obj.goal, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new FollowJointTrajectoryActionGoal();
    ...
    tmp = FollowJointTrajectoryGoal.deserialize(buffer);
    data.goal = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,

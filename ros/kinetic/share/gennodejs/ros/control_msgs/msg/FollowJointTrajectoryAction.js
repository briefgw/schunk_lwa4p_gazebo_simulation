...
class FollowJointTrajectoryAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = FollowJointTrajectoryActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = FollowJointTrajectoryActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = FollowJointTrajectoryActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new FollowJointTrajectoryAction();
    // Deserialize message field [action_goal]
    tmp = FollowJointTrajectoryActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = FollowJointTrajectoryActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = FollowJointTrajectoryActionFeedback.deserialize(buffer);

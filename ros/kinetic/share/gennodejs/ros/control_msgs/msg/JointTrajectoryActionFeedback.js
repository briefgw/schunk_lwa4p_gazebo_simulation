...
class JointTrajectoryActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = JointTrajectoryFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new JointTrajectoryActionFeedback();
    ...
    tmp = JointTrajectoryFeedback.deserialize(buffer);

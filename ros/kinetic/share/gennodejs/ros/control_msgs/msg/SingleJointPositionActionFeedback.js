...
class SingleJointPositionActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = SingleJointPositionFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new SingleJointPositionActionFeedback();
    ...
    tmp = SingleJointPositionFeedback.deserialize(buffer);

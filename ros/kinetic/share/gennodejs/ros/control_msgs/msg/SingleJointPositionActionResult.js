...
class SingleJointPositionActionResult {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = SingleJointPositionResult.serialize(obj.result, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new SingleJointPositionActionResult();
    ...
    tmp = SingleJointPositionResult.deserialize(buffer);

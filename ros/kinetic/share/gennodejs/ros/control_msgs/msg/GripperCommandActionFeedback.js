...
class GripperCommandActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = GripperCommandFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GripperCommandActionFeedback();
    ...
    tmp = GripperCommandFeedback.deserialize(buffer);

...
if("FALSE" STREQUAL "TRUE")
  set(eigen_stl_containers_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-eigen-stl-containers-0.1.5)
  set(eigen_stl_containers_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-eigen-stl-containers-0.1.5/obj-x86_64-linux-gnu/devel)
  ...
  set(eigen_stl_containers_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()

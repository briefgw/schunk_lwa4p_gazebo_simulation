...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rviz-1.12.1)
  set(rviz_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rviz-1.12.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()

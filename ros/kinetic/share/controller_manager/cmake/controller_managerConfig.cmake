...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-controller-manager-0.11.0)
  set(controller_manager_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-controller-manager-0.11.0/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()

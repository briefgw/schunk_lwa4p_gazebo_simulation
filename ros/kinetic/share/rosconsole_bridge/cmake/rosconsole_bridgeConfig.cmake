...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_bridge_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-bridge-0.4.4)
  set(rosconsole_bridge_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rosconsole-bridge-0.4.4/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()

...
//#line 280 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CompressedSubscriberConfig::AbstractParamDescriptionConstPtr(new CompressedSubscriberConfig::ParamDescription<std::string>("mode", "str", 0, "Color Mode", "{'enum_description': 'Enum to set the decompression color mode', 'enum': [{'srcline': 9, 'description': 'keep image encoding', 'srcfile': '/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg', 'cconsttype': 'const char * const', 'value': 'unchanged', 'ctype': 'std::string', 'type': 'str', 'name': 'unchanged'}, {'srcline': 10, 'description': 'decode to gray', 'srcfile': '/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg', 'cconsttype': 'const char * const', 'value': 'gray', 'ctype': 'std::string', 'type': 'str', 'name': 'gray'}, {'srcline': 11, 'description': 'decode to color', 'srcfile': '/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg', 'cconsttype': 'const char * const', 'value': 'color', 'ctype': 'std::string', 'type': 'str', 'name': 'color'}]}", &CompressedSubscriberConfig::mode)));
//#line 280 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_unchanged = "unchanged";
//#line 10 "/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_gray = "gray";
//#line 11 "/tmp/binarydeb/ros-kinetic-compressed-image-transport-1.9.3/cfg/CompressedSubscriber.cfg"
